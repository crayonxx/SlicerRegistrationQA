...
""" # replace with organization, grant and thanks.
    ...
    try:
      ...
      slicer.selfTests = {}
    slicer.selfTests['CreateRegistrationHierarchy'] = self.runTest

  def runTest(self):
    tester = CreateRegistrationHierarchyTest()
    tester.runTest()

#
# qCreateRegistrationHierarchyWidget
#

class CreateRegistrationHierarchyWidget(ScriptedLoadableModuleWidget):
  ...
  def onReloadAndTest(self,moduleName="CreateRegistrationHierarchy"):
    try:
      self.onReload()
...
#
# CreateRegistrationHierarchyLogic
#

class CreateRegistrationHierarchyLogic:
...
class CreateRegistrationHierarchyTest(unittest.TestCase):
  """
  ...
  def runTest(self):
    ...
    """
    self.setUp()
    self.test_CreateRegistrationHierarchy1()

  def test_CreateRegistrationHierarchy1(self):
